...
const Portfolio = () => {
    const portfolioProject = [
        { 
            image: '/images/musicweekly.jpg', 
            title: <a href="https://musicweekly.herokuapp.com/" target="_blank" rel="noreferrer">Music Weekly</a>, 
            description: "short explanation of project",
            github: "https://github.com/priyaaaryan/Music-Weekly.git"
        },
        { 
            image: '/images/note-taker.png', 
            title: <a href="https://polar-hollows-33539.herokuapp.com/" target="_blank" rel="noreferrer">Note Taker</a>, 
            description: "short explanation of project",
